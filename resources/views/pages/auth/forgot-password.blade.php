...
<head>
    ...
    <title>Forgot Password - EduClarity</title>
        ...
        <div class="flex w-full flex-col items-center justify-center bg-slate-50 p-6 lg:w-1/2 animate-slide-in-right">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 text-center animate-fade-in-scale" style="animation-delay: 0.1s;">
                    ...
                    <p class="mt-2 text-slate-500 font-medium">Forgot your password? No problem. Just let us know your email address.</p>
                </div>

                <!-- Session Status (Pesan sukses jika link berhasil dikirim) -->
                @if (session('status'))
                    <div class="mb-4 rounded-lg bg-green-50 p-4 text-sm font-medium text-green-600 border border-green-200 text-center animate-slide-up" style="animation-delay: 0.15s;">
                        {{ session('status') }}
                    </div>
                @endif
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                        ...
                        <div class="pt-2 animate-slide-up" style="animation-delay: 0.4s;">
                            <button type="submit" 
                                ...
                                Email Password Reset Link <span class="ml-2">&rarr;</span>
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="mt-8 text-center text-sm font-medium text-slate-500 animate-slide-up" style="animation-delay: 0.5s;">
                    Or, return to 
